...
# Taken from: https://github.com/tensorflow/agents/blob/v0.7.1/tf_agents/policies/gaussian_policy.py
...
class CustomGaussianPolicy(tf_policy.TFPolicy):
    ...
    """
        ...
        super(CustomGaussianPolicy, self).__init__(
        ...
        def _create_normal_distribution(action_spec):
            return CustomNormal(loc=tf.zeros(action_spec.shape, dtype=action_spec.dtype),
