from agents.td3_inverting_gradients import *


class Td3InfoPlusTdError(collections.namedtuple('Td3InfoPlusTdError', ('actor_loss', 'critic_loss',
...
class Td3AgentReverb(Td3AgentInvertingGradients):
    def _train(self, experience, weights=None):
        ...
        with tf.GradientTape(watch_accessed_variables=False) as tape:
            ...
            (critic_loss, td_errors_mean) = self.critic_loss(time_steps, actions, next_time_steps,
        ...
        return tf_agent.LossInfo(total_loss, Td3InfoPlusTdError(actor_loss, critic_loss, td_errors_mean))
    ...
    """
        with tf.name_scope('critic_loss'):
            ...
            return tf.reduce_mean(input_tensor=critic_loss), \
                   tf.stop_gradient(td_targets - tf.math.divide(pred_td_targets_all[0] +
